...
class ViewController: UIViewController,UIScrollViewDelegate,UIGestureRecognizerDelegate {
    ...
    let topOffsetY = functionHeaderViewHeight
    ...
    lazy var mainTableView: IndexTableView = {
        ...
        let orginY =  functionHeaderViewHeight
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        self.coverNavView.alpha = y / 10
        self.coverNavView.isHidden = false
        self.mainNavView.isHidden = true
        if y <= 0 {
            self.coverNavView.isHidden = true
            self.mainNavView.isHidden = false
